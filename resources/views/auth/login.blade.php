    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-gray-800 rounded-xl shadow-2xl p-8 border border-gray-700">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-white mb-2">Üdvözlünk újra!</h2>
                <p class="text-gray-400 text-sm">Lépj be a fiókodba a folytatáshoz</p>
            </div>
            ...
            <div class="flex items-center mb-6">
                ...
                <span class="px-3 text-xs text-gray-500 uppercase tracking-wide">Vagy emaillel</span>
                <div class="flex-grow border-t border-gray-600"></div>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-1">
                        <label for="password" class="block text-sm font-medium text-gray-300">Jelszó</label>
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-xs text-blue-400 hover:text-blue-300 transition">Elfelejtetted?</a>
                        @endif
                    </div>
            ...
            <p class="mt-8 text-center text-sm text-gray-400">
                Még nincs fiókod? 
                <a href="{{ route('register') }}" class="text-blue-400 hover:text-blue-300 font-medium transition">Regisztrálj itt</a>
            </p>
        </div>
    </div>
</body>
